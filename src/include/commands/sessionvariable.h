...
extern void saveSessionVariable(sessionVariable *result, Node *expr, bool exists, bool new_strict_type);
...
extern void setSessionVariable(char *varname, Node *expr, bool new_strict_type);
